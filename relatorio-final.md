...
pontuais. Escolhida por integrar nativamente contexto de projeto persistente
(`CLAUDE.md`), regras por escopo de diretório e servidores MCP, mantendo todo o
fluxo dentro do terminal já usado para Git — ver `docs/adr/0001-escolha-da-ferramenta-de-ia.md`.
...
Definir uma regra de escopo que efetivamente sobrepusesse o CLAUDE.md raiz sem
duplicar convenções. Resolvido criando `tests/CLAUDE.md` apenas com regras
