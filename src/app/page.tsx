  ...
  return (
    <main className={styles.dashboardContainer}>
      ...
      <section className={styles.quickActionsGrid}>
        <Link href="/provas/nova" className={styles.quickActionCard}>
          <div className={styles.quickActionInfo}>
            <span className={styles.quickActionTitle}>⚡ Montar Prova</span>
          </div>
          <span className={styles.quickActionArrow}>&rarr;</span>
        </Link>

        <Link href="/questoes" className={styles.quickActionCard}>
          <div className={styles.quickActionInfo}>
            <span className={styles.quickActionTitle}>🤖 Gerar Questões com IA</span>
          </div>
          <span className={styles.quickActionArrow}>&rarr;</span>
        </Link>

        <Link href="/provas" className={styles.quickActionCard}>
          <div className={styles.quickActionInfo}>
            <span className={styles.quickActionTitle}>📋 Ver Provas</span>
          </div>
          <span className={styles.quickActionArrow}>&rarr;</span>
        </Link>
        ...
        <Link href="/questoes" className={styles.quickActionCard}>
          <div className={styles.quickActionInfo}>
            <span className={styles.quickActionTitle}>📚 Banco de Questões</span>
          </div>
          <span className={styles.quickActionArrow}>&rarr;</span>
        </Link>
      </section>
